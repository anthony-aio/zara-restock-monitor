...
# Leave empty [] to alert on ANY size
# After running once, replace with the Medium size ID you see in logs
# Example: TARGET_SIZE_IDS = ["5188"]
TARGET_SIZE_IDS = []
        ...
        "embeds": [
            {
                ...
                "color": 0x00FF88,
                "footer": {
                    "text": "Zara Stock Monitor • Act fast — sizes go quickly!"
                },
            }
        ],
    }
